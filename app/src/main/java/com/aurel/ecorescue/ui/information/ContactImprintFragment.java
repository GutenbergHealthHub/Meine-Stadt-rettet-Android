...
public class ContactImprintFragment extends Fragment {

    public ContactImprintFragment() {}

    private NavigationDrawer mDrawerHelper;

    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_contact_imprint, container, false);
    }
    ...
    public void onViewCreated(@NotNull View view, Bundle savedInstanceState){
        ...
        toolbar.setTitle(R.string.drawer_about_contact);
        ...
        query.whereEqualTo("type", "contact");
